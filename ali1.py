...
vipro = LINETCR.LINE()
#vipro.login(qr=True)
vipro.login(token='Et6GtdHcgCU5pX44cNXd.+YJQegCzmlp/DpdIuBUA7q.FUn9ecFx3RrrGKRvtQ2lkK+Lhl4CUKQF9O4ZrWd6ia4=')
vipro.loginResult()
...
Bots=[mid]
Creator=["uff28ea10671930b3fe74f0e251bb9aed","uf47e9003420f75f8373e9bb19b3984c7"]
admin=["uff28ea10671930b3fe74f0e251bb9aed","uf47e9003420f75f8373e9bb19b3984c7"]
...
wait = {
    ...
    'timeline':True,
    "Timeline":True,
    "comment":"Bot Auto Like ©By : TEAM NB\nContact Me : 👉 line.me/ti/p/~klabakan16",    
    "commentOn":True,
    "commentBlack":{},
