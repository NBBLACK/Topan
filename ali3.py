...
#vipro.login(qr=True)
vipro.login(token='EtTYJReYP74bO9ZdbQAd.+YJQegCzmlp/DpdIuBUA7q.CMyijypv7TSgbDIEwOLHaqZph/U3UBOb+DsZq89ZnHE=')
vipro.loginResult()
print "Vipro-Login Success\n"

km = LINETCR.LINE() #(bot ini di luar grup fungsinya jadi algojo kaya kicker siri)
#km.login(qr=True)
km.login(token='Etgmj9UHfOkhfl8L8ph3.juggmkkvlw6zSUXT/gRP0W.VHZCIjka3kRInIrNBs1sofgYsTPp4t9z0vfybNr9cP8=')
km.loginResult()
...
Bots=[mid,Fmid,"u25418630a2952d6e99b2ec6df86ae9d3"]
