...
cl = LINETCR.LINE()
#cl.login(qr=True)
cl.login(token='Et0CERaqeX7z5QM9FmPd.NfeWDEi6iLtYNOZivRKhhq.dgwbAXjWClNVIv8L6EHXITZAYFBXLYINJohpLnLN6uo=')
cl.loginResult()
print "Cl-Login Success\n"

ki = LINETCR.LINE()
#ki.login(qr=True)
ki.login(token='EtyOoIjD3SasSHRC13Ub.PHgLG36XyyZ90kf7yGClYW.BqhDNoQlPX4ynKvUGmpJTvfZVTDvSRbJwPhcKHQltf4=')
ki.loginResult()
print "Ki-Login Success\n"

kk = LINETCR.LINE()
#kk.login(qr=True)
kk.login(token='EtiXHgxqFKvpNdnhvoYa.UxLR9GbdJuwn8bmEckdV/G.9LxoO1q1QK9o1BwOtPvBAq1jxL8/m/WA6fOK1LYntk8=')
kk.loginResult()
print "Kk-Login Success\n"

kc = LINETCR.LINE()
#kc.login(qr=True)
kc.login(token='EtxRtiql4EKNQD5WE88d.MolSX3wRyeLoz9JPKv22hq.onA7NDeSPa/Q3ToblgtQkweMeDNp8DKfpRHxFfydDbw=')
kc.loginResult()
print "Kc-Login Success\n"

kr = LINETCR.LINE()
#kr.login(qr=True)
kr.login(token='EtyOoIjD3SasSHRC13Ub.PHgLG36XyyZ90kf7yGClYW.BqhDNoQlPX4ynKvUGmpJTvfZVTDvSRbJwPhcKHQltf4=')
kr.loginResult()
print "Kr-Login Success\n"

vipro = LINETCR.LINE() #(isi dengan akun utama fungsinya biar akun utama di kick langsung di invite bot)
#vipro.login(qr=True)
vipro.login(token='Et0CERaqeX7z5QM9FmPd.NfeWDEi6iLtYNOZivRKhhq.dgwbAXjWClNVIv8L6EHXITZAYFBXLYINJohpLnLN6uo=')
vipro.loginResult()
print "Vipro-Login Success\n"

km = LINETCR.LINE() #(bot ini di luar grup fungsinya jadi algojo kaya kicker siri)
#km.login(qr=True)
km.login(token='EtmOCLNl8XEcf1PmujT3.juggmkkvlw6zSUXT/gRP0W.IpyNg4dKZtpnJTIOJT+2Hqq1ioXB5TZLc/C5zllTI2U=')
km.loginResult()
...
╚═════════════════════════
"""
vip="u25418630a2952d6e99b2ec6df86ae9d3"
...
Bots=[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,"u25418630a2952d6e99b2ec6df86ae9d3"]
Creator=["ucd2a3d8f98e1c8bcee34e8976e96cda8","u9c513075e23a2254f29e8cc856b9071d","ub9796bf600438d458df0131e08a0effa","u98e2ecc775ab60494e67d8e9915db61d","uff28ea10671930b3fe74f0e251bb9aed","u25418630a2952d6e99b2ec6df86ae9d3"]
admin=["ucd2a3d8f98e1c8bcee34e8976e96cda8","u9c513075e23a2254f29e8cc856b9071d","ub9796bf600438d458df0131e08a0effa","u98e2ecc775ab60494e67d8e9915db61d","uff28ea10671930b3fe74f0e251bb9aed","u25418630a2952d6e99b2ec6df86ae9d3","u322fd3d219a3a71362e6f3e0c55a6c30"]
...
wait = {
    ...
    'timeline':True,
    "Timeline":True,
    "comment1":"Auto Like ©By : 💠 ✍ NB_TEAM_BOT ✍ 💠 : line.me/ti/p/~klabakan16",
    "comment2":"Auto Like ©By : 💠 ✍ NB_TEAM_BOT ✍ 💠 : line.me/ti/p/~klabakan16",
    "comment3":"Auto Like ©By : 💠 ✍ NB_TEAM_BOT ✍ 💠 : line.me/ti/p/~klabakan16",
    "comment4":"Auto Like ©By : 💠 ✍ NB_TEAM_BOT ✍ 💠 : line.me/ti/p/~klabakan16",
    "comment5":"Auto Like ©By : 💠 ✍ NB_TEAM_BOT ✍ 💠 : line.me/ti/p/~klabakan16",
    "commentOn":True,
    "commentBlack":{},
    ...
    try:
	 ...
	 if wait["Ghost"] == True:
		...
		cl.sendText(msg.to,"Itu Owner Saya (^_^)")
                ...
                msg.contentType = 13
                admin1 = "ucd2a3d8f98e1c8bcee34e8976e96cda8"
                admin2 = "uff28ea10671930b3fe74f0e251bb9aed"
                admin3 = "u25418630a2952d6e99b2ec6df86ae9d3"
                msg.contentMetadata = {'mid': vip}
                random.choice(KAC).sendMessage(msg)
                msg.contentMetadata = {'mid': admin1} #tanda
                random.choice(KAC).sendMessage(msg) #tanda
                msg.contentMetadata = {'mid': admin2} #tanda
                random.choice(KAC).sendMessage(msg) #tanda
                msg.contentMetadata = {'mid': admin3} #tanda
                random.choice(KAC).sendMessage(msg) #tanda               
